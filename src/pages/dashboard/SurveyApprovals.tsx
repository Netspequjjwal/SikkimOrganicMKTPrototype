...
const SurveyApprovals: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto py-4">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Yield Survey Approvals (SOFDA)</h1>
          <p className="text-sm text-gray-500 mt-1">Review and approve seasonal crop yield data submitted by ICS Providers.</p>
        </div>
